...
class AttendanceService {
  ...
  Future<List<AttendanceModel>> getAttendance(
      int idAcademicYear, String documentNumber) async {
    Uri url =
        Uri.parse('$path/Assistance/GetAssistanceByStudentDocumentNumber');
    ...
    if (response.statusCode == 200) {
      ...
      List<AttendanceModel> attendanceList =
          myList.map((e) => AttendanceModel.fromJson(e)).toList();
